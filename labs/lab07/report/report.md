...
![Удаление выделенного операнда из кода](image/14.png){#fig:001 width=70%}
...
![Написание программы](image/16.png){#fig:001 width=70%}

Создаю исполняемый файл и проверяю его работу, подставляя необходимые значение. (рис. @fig:001).

![Запуск файла и проверка его работы](image/17.png){#fig:001 width=70%}
...
![Запуск файла и проверка его работы](image/19.png){#fig:001 width=70%}
